...
enum{
	...
	eumDemod_ZWave,
	eumDemod_NBIOT_NPusch,
	eumDemod_NBIOT_NPrach,
	eumDemod_GPS,
	eumDemod_BDS,
	eumDemodMax,
};
...
enum{
	...
	eumGiShort,
	eumGiMax,
	eumGiLTF0, //Add for AX 1xLTF + 0.8GI
	eumGiLTF1, //2xLTF + 0.8GI
	eumGiLTF2, //2xLTF + 1.6GI
	eumGiLTF3, //4xLTF + 3.2GI
	eumGiLTF4, //4xLTF + 0.8GI 
	eumGiLTFMax
};
enum{
	eumFreqGroup2_4G,
...
enum{
	...
	eumChannelMax = 250,	//2.4G使用channel[1-14],5G使用[36-64],[100-140],[149-165],6G final 233
...
enum
{
	enumCarrier_Leakage = 0,    //载波泄露
    enumCarrier_Suppression		//载波抑制
};
